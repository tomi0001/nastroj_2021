...
@else
                ...
                <div class="moodSearchResult">
                    ...
                    <table>
                        ...
                        <tr class="bold">
                            ...
                            <td class="sizeTableMood showMood titleTheadMood" style="width: 15%;">
                                nazwa akcji
                            </td>
 ...
 @for ($i=0;$i < count($arrayList);$i++)
                        <tr>
                            ...
                            <td class="sizeTableMood showMood boldAction">
                                {{$listgroupActionDayName[$i]}}
                            </td>
                            @if ($arrayList[$i]["count"] == 0)
                            
                            <td class="sizeTableMood showMood " colspan="6">
                                <div class="ajaxError center">
                                    Nie ma dla tej akcji wyników
                                </div>
